...
// let reviewCreds = {movie_details_id: props.movie_details_id, user_id: props.user_id, review_content: reviewDetails.reviewContent};
...
console.log(response.data);
  ...
  onFinish();
    ...
    return (
        <Form {...layout} name="nest-messages" onFinish={validateReview} validateMessages={validateMessages}>
